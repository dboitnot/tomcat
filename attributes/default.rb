...
default['tomcat']['ssl_ciphers'] = "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256,TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA,TLS_RSA_WITH_AES_128_CBC_SHA256,TLS_RSA_WITH_AES_128_CBC_SHA"
...
# Parameters to support certificates in data bags
default['tomcat']['ssl_data_bag_cert_key'] = 'cert'
default['tomcat']['ssl_data_bag_private_key_key'] = 'private_key'
default['tomcat']['ssl_data_bag_ca_chain_key'] = 'ca_chain'

if node['tomcat']['ssl_data_bag']
  bag_item = Chef::DataBagItem.load(node['tomcat']['ssl_data_bag'], node['tomcat']['ssl_data_bag_item'])

  default['tomcat']['ssl_cert_file'] = "#{node['tomcat']['config_dir']}/ssl/cert.pem"
  default['tomcat']['ssl_key_file'] = "#{node['tomcat']['config_dir']}/ssl/key.pem"
  default['tomcat']['ssl_chain_files'] = bag_item[node['tomcat']['ssl_data_bag_ca_chain_key']]
    .fill { |i| "#{node['tomcat']['config_dir']}/ssl/cacert_#{i}.pem" }
else
...
if node['tomcat']['ssl_cert_file']
  default['tomcat']['keystore_file'] = 'keystore.p12'
